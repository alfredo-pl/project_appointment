...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { email: @business.email, name: @business.name, rut: @business.rut } }
    end
  ...
  test "should update business" do
    patch business_url(@business), params: { business: { email: @business.email, name: @business.name, rut: @business.rut } }
